...
const Upload = () => {
  ...
  return (
    <div className="pb-16">
      {/* Title */}
      <h1 className="text-center py-6 md:py-16 text-2xl md:text-3xl lg:text-4xl font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent">
