    ...
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
      ...
      <div>
        ...
        <p className="my-6 text-[15px] text-gray-500">
          Instantly remove backgrounds from any image with AI-powered precision.
          <br className="max-sm:hidden" /> Upload your photo and get a clean,
          transparent result — perfect for e-commerce, resumes, or creative
          design — all in seconds.
        </p>
        <div>
          <input
